...
function Lectures(){
    ...
    <section id="Lectures" className="Lectures__main">
      ...
      <div className='Lectures-row1'>
        ...
        <div className="Lectures-main__container">
      ...
      <div className='Lecture__button'>
        <button className='button_'><a href='https://drive.google.com/file/d/1BMwvZQsBqcipkQFD7wEOy6tg7GK8nYe-/view'>Past talk INFO</a></button>
      </div>
    </section>
    )
